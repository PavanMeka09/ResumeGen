  ...
  return (
    <>
      <motion.div
        ...
        className="h-96 w-80 relative bg-zinc-200 hover:scale-105 transition-[transform] dark:bg-zinc-700 rounded-2xl flex justify-center items-center flex-col gap-6 group"
      >
        <img
          onClick={handleClick}
          src={props.image}
          alt={props.title + " image"}
          className="h-[80%] cursor-zoom-in border-2"
        />
